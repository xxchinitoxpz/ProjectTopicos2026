                            ...
                            <tr class="hover:bg-gray-50/40 transition">
                                ...
                                <td class="py-3.5 px-6">
                                    <div class="flex items-center justify-center space-x-2">
                                        ...
                                        <form action="{{ route('admin.maintenance.destroy', $maintenance->id) }}" method="POST" onsubmit="return confirm('Esta seguro de eliminar este mantenimiento?');" class="inline">
                                            @csrf
                                            @method('DELETE')
