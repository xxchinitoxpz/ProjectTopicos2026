    ...
    <turbo-frame id="modal" data-modal-size="max-w-2xl">
        <div data-modal-size="max-w-2xl" 
             x-data="{
                 ...
                 daysRequested: '{{ old('days_requested', '') }}',
            ...
            <div class="flex items-center justify-between pb-4 border-b border-gray-100">
                <div>
                    <h3 class="text-lg font-bold text-usat-blue">Registrar Vacaciones</h3>
                    <p class="text-xs text-gray-400">Solicita un nuevo período de vacaciones para el personal elegible.</p>
                </div>
            ...
            <!-- Form Card -->
            <form action="{{ route('admin.vacation.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <select id="staff_id" name="staff_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 focus:ring-opacity-50 text-sm" required autofocus>
                        <option value="">-- Seleccionar Personal Elegible --</option>
                    ...
                    <p class="text-[10px] text-gray-400 mt-1">Nota: Solo el personal con contrato de tipo permanente o nombrado activo es elegible.</p>
                ...
                <div>
                    ...
                    <textarea id="notes" name="notes" rows="3" placeholder="Ej. Por motivos de salud, viaje programado, etc..." class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 focus:ring-opacity-50 text-sm">{{ old('notes') }}</textarea>
