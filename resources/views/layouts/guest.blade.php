    ...
    <body class="font-sans text-gray-900 antialiased bg-usat-light">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
            <div class="mb-6 flex flex-col items-center">
                ...
                <h2 class="mt-4 text-2xl font-bold text-usat-blue tracking-tight">RSU Recicla</h2>
                <p class="text-xs text-gray-500 mt-1 uppercase tracking-widest font-semibold">Gestión de Residuos & Sostenibilidad</p>
            </div>
